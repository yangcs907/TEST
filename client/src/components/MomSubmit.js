...
class MomSubmit extends Component {
  ...
  getState = () => {
    alert(`${this.state.name} ${this.state.location} ${this.state.email} ${this.state.occupation} ${this.state.bio} ${this.state.childAge} ${this.state.story} ${this.state.lessons} ${this.state.waiver}`);
    this.setState({
      name: "",
      location: "",
      email: "",
